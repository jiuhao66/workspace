...
class Client(Iface):
    ...
    def setPerson(self, person):
        ...
        Parameters:
         - person
        """
        self.send_setPerson(person)
        self.recv_setPerson()

    def send_setPerson(self, person):
        self._oprot.writeMessageBegin('setPerson', TMessageType.CALL, self._seqid)
        args = setPerson_args()
        args.person = person
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["setPerson"] = Processor.process_setPerson
    ...
    def process_setPerson(self, seqid, iprot, oprot):
        args = setPerson_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = setPerson_result()
        try:
            self._handler.setPerson(args.person)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except DataException as dataException:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("setPerson", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class setPerson_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setPerson_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setPerson_args)
setPerson_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'person', [Person, None], None, ),  # 1
)


class setPerson_result(object):
    """
    Attributes:
     - dataException
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setPerson_result')
        if self.dataException is not None:
            oprot.writeFieldBegin('dataException', TType.STRUCT, 1)
            self.dataException.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setPerson_result)
setPerson_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'dataException', [DataException, None], None, ),  # 1
)
